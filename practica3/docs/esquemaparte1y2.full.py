# -*- coding: utf-8 -*-
"""EsquemaParte1y2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LvxuEVEIsenrDR-Qvdh2fBKYz09HrdVi
"""
...
# En caso de necesitar instalar keras, ejecutar la siguiente línea:
# !pip install -q keras
...
# Incluir model.fit()
# Incluir función quye mkuestre la evolución del entrenamiento y validación
